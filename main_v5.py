    ...
    def run(self):
        for i, path in enumerate(self.paths):
            ...
            try:
                ...
                QThread.msleep(LOW_POWER_THUMBNAIL_DELAY_MS)
...
class SettingsPage(QWidget):
    ...
    def initUI(self):
        ...
        for label in (self.summary_folder, self.summary_interval, self.summary_mode, self.summary_clock, self.summary_alarm):
        ...
        section_hint = QLabel("选择相册、播放节奏和屏幕附加信息；播放页的操作方式与 v4 保持一致。")
        ...
        controls_layout.addWidget(self._makeSettingRow(
            "相册路径",
    ...
    def saveConfigSoon(self, delay_ms=CONFIG_SAVE_DEBOUNCE_MS):
